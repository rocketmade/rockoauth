...
describe RockOAuth::Provider::Authorization do
  ...
  before do
    ...
    RockOAuth.stub(:random_string).and_return('s1', 's2', 's3')
  end
  ...
  describe "#grant_access!" do
    ...
    describe "for token requests" do
      ...
      it "creates an Authorization in the database" do
        ...
        authorization.client.should == @client
        authorization.code.should be_nil
        authorization.access_token_hash.should == RockOAuth.hashify("s1")
        authorization.refresh_token_hash.should == RockOAuth.hashify("s2")
      end
    end
    ...
    describe "for code_and_token requests" do
      ...
      it "creates an Authorization in the database" do
        ...
        authorization.client.should == @client
        authorization.code.should == "s1"
        authorization.access_token_hash.should == RockOAuth.hashify("s2")
        authorization.refresh_token_hash.should == RockOAuth.hashify("s3")
      end
    end
  end
