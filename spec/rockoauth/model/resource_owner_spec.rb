...
describe RockOAuth::Model::ResourceOwner do
  ...
  describe "#grant_access!" do
    ...
    it "creates an authorization between the owner and the client" do
      ...
      RockOAuth::Model::Authorization.should_receive(:new).and_return(authorization)
      @owner.grant_access!(@client)
    end

    # This is hacky, but doubleing ActiveRecord turns out to get messy
    it "creates an Authorization" do
      RockOAuth::Model::Authorization.count.should == 0
      @owner.grant_access!(@client)
      RockOAuth::Model::Authorization.count.should == 1
    end

    it "returns the authorization" do
      @owner.grant_access!(@client).should be_kind_of(RockOAuth::Model::Authorization)
    end
  ...
  it "destroys its authorizations on destroy" do
    ...
    @owner.destroy
    RockOAuth::Model::Authorization.count.should be_zero
  end
end
